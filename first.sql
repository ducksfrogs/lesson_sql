INSERT into weather
  (city, temp_lo, temp_hi,prcp, date ) VALUES
        ('Cicago', 35, 48, 0.24 ,CURRENT_TIMESTAMP);
...
INSERT into weather2
  (city, temp_lo, temp_hi,prcp, date_inputed ) VALUES
        ('Tokyo', 35, 48, 0.24 ,CURRENT_TIMESTAMP);

INSERT into weather2
  (city, temp_lo, temp_hi,prcp, date_inputed ) VALUES
        ('Tokyo', 32, 45, 0.5 , '2010-09-02');

INSERT into weather2
(city, temp_lo, temp_hi,prcp, date_inputed ) VALUES
      ('Tokyo', 35, 48, 0.24 ,CURRENT_TIMESTAMP);
("Osaka",25,39,0.45, CURRENT_TIMESTAMP),
("Kyoto",39,59,24,"2011-02-01"),
("Nagoya",30,40,0.33,"2010-01-01")
...
INSERT into home (id, Sell, List, Living, Rooms, Beds, Baths, Age, Acres, Taxes) VALUES
(142	160	28	10	5	3	60	0.28	3167);


INSERT into home (Sell, List, Living, Rooms, Beds, Baths, Age, Acres, Taxes) VALUES
(142,160,28,10,5,3,60,0.28,3167),
...
(129,135,10,6,3,1,15,1,243),
(143,145,21,7,4,2,10,1.2,3529),
